...
//     const buttons = ["welcome", /* "conditions", */ "aboutMe", "myProjects", "contact"];
...
//         <div 
//             className={`
//                 fixed px-8 top-0 z-10 w-full h-15 flex items-center transition-color duration-400
//                 ${scrolled ? 'bg-black/40 backdrop-blur-2xl' : 'bg-transparent'}
//             `}
//         >
//             <nav className="max-w-[1280px] w-full mx-auto flex justify-between">
//                 <Logo />

//                 <div className='flex-1 flex justify-center'>
//                     <div className='max-w-[450px] w-full flex gap-4 justify-between pt-2'>
//                         {buttons.map((item) => {
//                             const sectionId = PagesID[item];
//                             const isActive = sectionId.includes(activeSection)
//                             return (
//                                 <div className='' key={item}>
//                                     <div
//                                         className={`text-sm uppercase font-bold p-0 hover:cursor-pointer  transition-all hover:text-(--primary)/80 ${isActive && 'text-(--primary)'}`}
//                                         onClick={() => handleScrollTo(item)}
//                                     >
//                                         {t(item)} {/* {sectionId} */}
//                                     </div>
//                                     {isActive && <div className='h-[2px] rounded-2xl mx-auto bg-(--primary)'/>}
//                                 </div>
//                             );
//                         })}
//                     </div>
